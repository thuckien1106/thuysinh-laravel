...
<div class="auth-container">
    <div class="auth-card">
        <div class="auth-header">
            ...
            <p class="text-muted small mb-0">Thiết lập mật khẩu mới cho tài khoản của bạn</p>
        </div>
        ...
        <form method="POST" action="{{ route('password.reset.submit') }}">
            ...
            <!-- Mã xác minh -->
            <div class="mb-4">
                <label class="form-label">Mã xác minh (Code)</label>
                <div class="input-group">
                    <span class="input-group-text"><i class="bi bi-upc-scan"></i></span>
                    <input type="text" class="form-control form-control-custom" name="code" 
                           maxlength="6" placeholder="Nhập mã 6 số..." required autofocus>
                </div>
            </div>
