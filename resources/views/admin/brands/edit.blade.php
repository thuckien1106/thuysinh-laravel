...
<div class="page-header">
    <div>
        <h3 class="fw-bold m-0 text-dark">Cập nhật thương hiệu</h3>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 small">
                ...
                <li class="breadcrumb-item active" aria-current="page">Sửa #{{ $brand->id }}</li>
            </ol>
        </nav>
    </div>
    <div>
...
<div class="form-card">
    <div class="form-card-header">
        ...
        <h5 class="form-card-title">Thông tin thương hiệu</h5>
    </div>
        ...
        <form method="POST" action="{{ route('admin.brands.update', $brand->id) }}">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="slug" class="form-control bg-light text-muted" 
                           value="{{ old('slug', $brand->slug) }}" placeholder="tự-động-tạo-nếu-để-trống">
