...
<style>
  ...
  #heroSlider .carousel-item section.hero-ocean {
    margin: 0;
    border-radius: 22px;
  }
...
{{-- ================= HERO SLIDER ================= --}}
<div id="heroSlider" class="carousel slide mb-5 container-fluid px-0" 
     data-bs-ride="carousel" data-bs-interval="4000">

  <div class="carousel-inner" style="border-radius:22px; overflow:hidden;">

    <div class="carousel-item active">
      <section class="hero-ocean w-100 mx-auto">
        <div class="text">
          <h1 class="hero-title">Thế giới thủy sinh ngay trong ngôi nhà bạn</h1>
          <p>Cây, cá cảnh và phụ kiện chất lượng, giao nhanh, hướng dẫn tận tâm.</p>
          <a href="#products" class="btn btn-ocean">Khám phá ngay</a>
        </div>
        <img src="{{ asset('assets/img/hero_fish.jpg') }}" alt="">
      </section>
    </div>
    ...
    <div class="carousel-item">
      <section class="hero-ocean w-100 mx-auto">
        <div class="text">
          <h1 class="hero-title">Bể thủy sinh cao cấp – Setup tận nơi</h1>
          <p>Tư vấn thiết kế – bảo dưỡng định kỳ – bố cục chuẩn nghệ thuật.</p>
        </div>
        <img src="{{ asset('assets/img/hero_aquarium.jpg') }}" alt="">
      </section>
    </div>
    ...
    <div class="carousel-item">
      <section class="hero-ocean w-100 mx-auto">
        <div class="text">
          <h1 class="hero-title">Phụ kiện thủy sinh đầy đủ – Giá tốt</h1>
          <p>Đèn – CO₂ – lọc – nền – vi sinh… mọi thứ bạn cần đều có tại AquaShop.</p>
        </div>
        <img src="{{ asset('assets/img/hero_plants.jpg') }}" alt="">
      </section>
    </div>
